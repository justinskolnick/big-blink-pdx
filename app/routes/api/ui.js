  ...
  try {
    data = {
      labels: {
        ...
        incidentsNoResults: labels.getLabel('no_results', 'incidents'),
        introduction: labels.getLabel('introduction'),
        listHasBeenFiltered: labels.getLabel('is_filtered', 'list'),
        listNoResults: labels.getLabel('no_results', 'list'),
        listShowingAllResults: labels.getLabel('showing_all_results', 'list'),
        listShowingAllResultsFilteredSearch: labels.getLabel('showing_all_results_filtered_search', 'list'),
